...
<body>
  ...
  <div id="timings" >
	...
	<span class="timingstext"> 
Weekends: 10 am to 1pm.</span>
  </div>
  ...
  <div id="edit">
	...
	<form id="editcontents" action="edit.php?name=SBI Bank" method='post'>
		...
		<br><b>Timings</b>:
			...
			<br><input type="text" class="form-control" value="
Weekends: 10 am to 1pm" style="display:inline-block;width:80%;" name="tim_2"></input>
