...
Hauz Khas..<br>
  ...
  <div id="timings" >
	<h3>Timings :</h3>
	<br />
<b>Notice</b>:  Undefined offset: 1 in <b>C:\xampp\htdocs\campusrover\templates\eateries\template.php</b> on line <b>234</b><br />
	<span class="timingstext"> , </span> <br />
  ...
  <div id="menu">
	...
	<div id="description">
	  ...
	  <div id="descriptiontext">
		Sab sada bhusa milta hai. Kuchh khane layak nahi hai. <br/>
	  </div>  
	 </div>
  ...
  <div id="edit">
	<h3>Edit contents:</h3>
	<form id="editcontents" action="edit.php?name=Amul" method='post'>
		<b>Name</b>: Amul		<br><b>Type</b>: Eatery		<br><b>Latitude</b>:<input type="text" class="form-control" value="28.54480890" style="display:inline-block;width:33%;" name="lat"></input>
		<br><b>Longitude</b>:<input type="text" class="form-control" value="77.19151268" style="display:inline-block;width:33%;" name="long"></input>
		<br><b>Photo</b>:
		<br><button class="btn btn-default" style="width:25%">Add Photo</button>
		<br><b>Description</b>:
		<br><textarea rows="2" cols="30" style="padding:2%;overflow-y:scroll;" name="description">Sab sada bhusa milta hai. Kuchh khane layak nahi hai.</textarea></input>
		<br><b>Rating</b>: 5.0		<br><b>Address</b>:
			<br><input type="text" class="form-control" value="Amul" style="display:inline-block;width:80%;" name="add_l1"></input>
			<br><input type="text" class="form-control" value="
IIT Delhi" style="display:inline-block;width:80%;" name="add_l2"></input>
			<br><input type="text" class="form-control" value="
Hauz Khas." style="display:inline-block;width:80%;" name="add_l3"></input>			
		<br><b>Timings</b>:
			<br><input type="text" class="form-control" value="" style="display:inline-block;width:80%;" name="tim_1"></input>
...
<footer>
 ...
 <!-- js -->
  ...
  <script type="text/javascript">
    ...
    function initialize() {
		var myCenter=new google.maps.LatLng(28.54480890,77.19151268);
        var mapOptions = {
          center: myCenter,
          zoom: 18,		  	 
		  panControl:true,
