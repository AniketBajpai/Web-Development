...
<body>
  ...
  <div id="timings" >
	<h3>Timings :</h3>
		<span class="timingstext"> Open 24x7, </span> <br />
	<span class="timingstext"> .</span>
  </div>
  ...
  <div id="menu">
	...
	<div id="description">
	  ...
	  <div id="descriptiontext">
		In general, food is hopeless. Doughnut is ok, and double deck psneer pizza is good. <br/>
	  </div>  
	 </div>
  ...
  <div id="edit">
	<h3>Edit contents:</h3>
	<form id="editcontents" action="edit.php?name=Lipton" method='post'>
		<b>Name</b>: Lipton		<br><b>Type</b>: Eatery		<br><b>Latitude</b>:<input type="text" class="form-control" value="28.54475707" style="display:inline-block;width:33%;" name="lat"></input>
		<br><b>Longitude</b>:<input type="text" class="form-control" value="77.19117472" style="display:inline-block;width:33%;" name="long"></input>
		<br><b>Photo</b>:
		<br><button class="btn btn-default" style="width:25%">Add Photo</button>
		<br><b>Description</b>:
		<br><textarea rows="2" cols="30" style="padding:2%;overflow-y:scroll;" name="description">In general, food is hopeless. Doughnut is ok, and double deck psneer pizza is good.</textarea></input>
		<br><b>Rating</b>: 5.0		<br><b>Address</b>:
			<br><input type="text" class="form-control" value="IITD insti area" style="display:inline-block;width:80%;" name="add_l1"></input>
			<br><input type="text" class="form-control" value="In front of cycling stand" style="display:inline-block;width:80%;" name="add_l2"></input>
			<br><input type="text" class="form-control" value="IIT Delhi" style="display:inline-block;width:80%;" name="add_l3"></input>			
		<br><b>Timings</b>:
			<br><input type="text" class="form-control" value="Open 24x7" style="display:inline-block;width:80%;" name="tim_1"></input>
			<br><input type="text" class="form-control" value="" style="display:inline-block;width:80%;" name="tim_2"></input>
...
<footer>
 ...
 <!-- js -->
  ...
  <script type="text/javascript">
    ...
    function initialize() {
		var myCenter=new google.maps.LatLng(28.54475707,77.19117472);
        var mapOptions = {
          center: myCenter,
          zoom: 18,		  	 
		  panControl:true,
