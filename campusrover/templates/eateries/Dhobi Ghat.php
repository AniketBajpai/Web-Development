  ...
  <div id="addressbox">
	...
	<div id="address">
		<span id="directions">Get Directions<br></span>
				Behing Nigiri hostel,<br>
		
Near Vikramshila apartments,<br>
...
IIT Delhi..<br>
  ...
  <div id="timings" >
	<h3>Timings :</h3>
		<span class="timingstext"> 7am to 9pm, </span> <br />
  ...
  <div id="edit">
	<h3>Edit contents:</h3>
	<form id="editcontents" action="edit.php?name=Dhobi Ghat" method='post'>
		<b>Name</b>: Dhobi Ghat		<br><b>Type</b>: Dhobiwalla		<br><b>Latitude</b>:<input type="text" class="form-control" value="28.54620846" style="display:inline-block;width:33%;" name="lat"></input>
		<br><b>Longitude</b>:<input type="text" class="form-control" value="77.18180794" style="display:inline-block;width:33%;" name="long"></input>
		<br><b>Photo</b>:
		<br><button class="btn btn-default" style="width:25%">Add Photo</button>
		<br><b>Description</b>:
		<br><textarea rows="2" cols="30" style="padding:2%;overflow-y:scroll;" name="description">Cheap</textarea></input>
		<br><b>Rating</b>: 5.0		<br><b>Address</b>:
			<br><input type="text" class="form-control" value="Behing Nigiri hostel" style="display:inline-block;width:80%;" name="add_l1"></input>
			<br><input type="text" class="form-control" value="
Near Vikramshila apartments" style="display:inline-block;width:80%;" name="add_l2"></input>
			<br><input type="text" class="form-control" value="
IIT Delhi." style="display:inline-block;width:80%;" name="add_l3"></input>			
		<br><b>Timings</b>:
			<br><input type="text" class="form-control" value="7am to 9pm" style="display:inline-block;width:80%;" name="tim_1"></input>
...
<footer>
 ...
 <!-- js -->
  ...
  <script type="text/javascript">
    ...
    function initialize() {
		var myCenter=new google.maps.LatLng(28.54620846,77.18180794);
        var mapOptions = {
          center: myCenter,
          zoom: 18,		  	 
		  panControl:true,
