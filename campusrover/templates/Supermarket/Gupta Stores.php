...
<body>
  ...
  <div id="header">
		<h1 id="placename">Gupta Stores</h1>
		<div id="rating">
			<div id="ratingtext">Rating :</div>
			<div class="progress" >
			  <div class="progress-bar progress-bar-success" role="progressbar" aria-valuemin="0" aria-valuemax="100">
				<span id="ratingvalue">7.0 / 10 </span>
			  </div>
			</div>
		</div>
  ...
  <div id="addressbox">
	...
	<div id="address">
		<span id="directions">Get Directions<br></span>
				Beside Nalanda Ground,<br>
		
Near Nilgiri hostel,<br>
...
IIT Delhi.<br>
  ...
  <div id="timings" >
	<h3>Timings :</h3>
		<span class="timingstext"> 9am to 9pm, </span> <br />
  ...
  <div id="menu">
	...
	<div id="description">
	  ...
	  <div id="descriptiontext">
		Contains all day to day use items. <br/>
	  </div>  
	 </div>
  ...
  <div id="edit">
	<h3>Edit contents:</h3>
	<form id="editcontents" action="edit.php?name=Gupta Stores" method='post'>
		<b>Name</b>: Gupta Stores		<br><b>Type</b>: Supermarket		<br><b>Latitude</b>:<input type="text" class="form-control" value="28.54592572" style="display:inline-block;width:33%;" name="lat"></input>
		<br><b>Longitude</b>:<input type="text" class="form-control" value="77.18305148" style="display:inline-block;width:33%;" name="long"></input>
		<br><b>Photo</b>:
		<br><button class="btn btn-default" style="width:25%">Add Photo</button>
		<br><b>Description</b>:
		<br><textarea rows="2" cols="30" style="padding:2%;overflow-y:scroll;" name="description">Contains all day to day use items.</textarea></input>
		<br><b>Rating</b>: 7.0		<br><b>Address</b>:
			<br><input type="text" class="form-control" value="Beside Nalanda Ground" style="display:inline-block;width:80%;" name="add_l1"></input>
			<br><input type="text" class="form-control" value="
Near Nilgiri hostel" style="display:inline-block;width:80%;" name="add_l2"></input>
			<br><input type="text" class="form-control" value="
IIT Delhi" style="display:inline-block;width:80%;" name="add_l3"></input>			
		<br><b>Timings</b>:
			<br><input type="text" class="form-control" value="9am to 9pm" style="display:inline-block;width:80%;" name="tim_1"></input>
...
<footer>
 ...
 <!-- js -->
  ...
  <script type="text/javascript">
    ...
    function initialize() {
		var myCenter=new google.maps.LatLng(28.54592572,77.18305148);
        var mapOptions = {
          center: myCenter,
          zoom: 18,		  	 
		  panControl:true,
