...
<body>
  ...
  <div id="menu">
	...
	<div id="description">
	  ...
	  <div id="descriptiontext">
		In general, food is hopeless. <br/>
	  </div>  
	 </div>
  ...
  <div id="edit">
	...
	<form id="editcontents" action="edit.php?name=Lipton" method='post'>
		...
		<br><b>Description</b>:
		<br><textarea rows="2" cols="30" style="padding:2%;overflow-y:scroll;" name="description">In general, food is hopeless.</textarea></input>
