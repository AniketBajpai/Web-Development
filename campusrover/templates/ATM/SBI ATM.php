...
<body>
  ...
  <div id="addressbox">
	...
	<div id="address">
		<span id="directions">Get Directions<br></span>
				Near SBI bank (after crossing the road),<br>
		 IIT Delhi,<br>
		 Hauz Khas..<br>
	</div>
  </div>
  ...
  <div id="menu">
	...
	<div id="description">
	  ...
	  <div id="descriptiontext">
		Never has Rs.100 notes or any cash for that matter. <br/>
	  </div>  
	 </div>
  ...
  <div id="edit">
	<h3>Edit contents:</h3>
	<form id="editcontents" action="edit.php?name=SBI ATM" method='post'>
		<b>Name</b>: SBI ATM		<br><b>Type</b>: ATM		<br><b>Latitude</b>:<input type="text" class="form-control" value="28.54373920" style="display:inline-block;width:33%;" name="lat"></input>
		<br><b>Longitude</b>:<input type="text" class="form-control" value="77.19287910" style="display:inline-block;width:33%;" name="long"></input>
		<br><b>Photo</b>:
		<br><button class="btn btn-default" style="width:25%">Add Photo</button>
		<br><b>Description</b>:
		<br><textarea rows="2" cols="30" style="padding:2%;overflow-y:scroll;" name="description">Never has Rs.100 notes or any cash for that matter.</textarea></input>
		<br><b>Rating</b>: 5.0		<br><b>Address</b>:
			<br><input type="text" class="form-control" value="Near SBI bank (after crossing the road)" style="display:inline-block;width:80%;" name="add_l1"></input>
...
<footer>
 ...
 <!-- js -->
  ...
  <script type="text/javascript">
    ...
    function initialize() {
		var myCenter=new google.maps.LatLng(28.54373920,77.19287910);
        var mapOptions = {
          center: myCenter,
          zoom: 18,		  	 
		  panControl:true,
