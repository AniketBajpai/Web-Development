...
<body>
  ...
  <div id="header">
		<h1 id="placename">SBI Bank</h1>
		<div id="rating">
			<div id="ratingtext">Rating :</div>
			<div class="progress" >
			  <div class="progress-bar progress-bar-success" role="progressbar" aria-valuemin="0" aria-valuemax="100">
				<span id="ratingvalue">5.0 / 10 </span>
			  </div>
			</div>
		</div>
  ...
  <div id="timings" >
	<h3>Timings :</h3>
		<span class="timingstext"> Weekdays: 10 am to 4pm, </span> <br />
	<span class="timingstext"> Weekends: 10 am to 1pm.</span>
  </div>
  ...
  <div id="menu">
	...
	<div id="description">
	  ...
	  <div id="descriptiontext">
		It is the official bank to carry out all transactions related to IIT Delhi, such as fee payment. It is a fully fledged bank, offering all functionalities. However, it is usually quite crowded. <br/>
	  </div>  
	 </div>
  ...
  <div id="edit">
	<h3>Edit contents:</h3>
	<form id="editcontents" action="edit.php?name=SBI Bank" method='post'>
		<b>Name</b>: SBI Bank		<br><b>Type</b>: Bank		<br><b>Latitude</b>:<input type="text" class="form-control" value="28.54500000" style="display:inline-block;width:33%;" name="lat"></input>
		<br><b>Longitude</b>:<input type="text" class="form-control" value="77.19220000" style="display:inline-block;width:33%;" name="long"></input>
		<br><b>Photo</b>:
		<br><button class="btn btn-default" style="width:25%">Add Photo</button>
		<br><b>Description</b>:
		<br><textarea rows="2" cols="30" style="padding:2%;overflow-y:scroll;" name="description">It is the official bank to carry out all transactions related to IIT Delhi, such as fee payment. It is a fully fledged bank, offering all functionalities. However, it is usually quite crowded.</textarea></input>
		<br><b>Rating</b>: 5.0		<br><b>Address</b>:
			<br><input type="text" class="form-control" value="Beside Central Workshop" style="display:inline-block;width:80%;" name="add_l1"></input>
			<br><input type="text" class="form-control" value="Near LHC" style="display:inline-block;width:80%;" name="add_l2"></input>
			<br><input type="text" class="form-control" value="IIT Delhi" style="display:inline-block;width:80%;" name="add_l3"></input>			
		<br><b>Timings</b>:
			<br><input type="text" class="form-control" value="Weekdays: 10 am to 4pm" style="display:inline-block;width:80%;" name="tim_1"></input>
			<br><input type="text" class="form-control" value="Weekends: 10 am to 1pm" style="display:inline-block;width:80%;" name="tim_2"></input>
...
<footer>
 ...
 <!-- js -->
  ...
  <script type="text/javascript">
    ...
    function initialize() {
		var myCenter=new google.maps.LatLng(28.54500000,77.19220000);
        var mapOptions = {
          center: myCenter,
          zoom: 18,		  	 
		  panControl:true,
