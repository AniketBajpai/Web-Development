...
$url = "http://localhost/codeigniter3/index.php/books/updatelawyer/name/".$name."/type/".$type."/region/".$region."/qualification/".$qualification."/availability/".$availability."/email/".$email."/phone/".$phone."/password/".$password."/";
