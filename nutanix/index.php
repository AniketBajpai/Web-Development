    ...
    <section class="col-xs-12 col-sm-12 col-md-12">
		...
		<article class="search-result row">
			<div class="col-xs-12 col-sm-12 col-md-3">
				<a href="#" title="Lorem ipsum" class="thumbnail"><img src="http://lorempixel.com/250/140/people" alt="<?php echo $m[$i]['Name']  ;  ?> " /></a>
			</div>
			<div class="col-xs-12 col-sm-12 col-md-4">
				<ul class="meta-search">
					<li><i class="glyphicon glyphicon-user"></i> <span><?php   echo $m[$i]['Name'] ;?></span></li>
					<li><i class="glyphicon glyphicon-globe"></i> <span><?php   echo $m[$i]['Address'] ;?></span></li>
					<li><i class="glyphicon glyphicon-pushpin"></i> <span><?php echo $m[$i]['region']  ?></span></li>
				</ul>
			</div>
			<div class="col-xs-12 col-sm-12 col-md-4 excerpet">
				<h3><i class="glyphicon glyphicon-hand-right"></i><a href="#" title=""><?php  echo $m[$i]['Title']  ;	?></a></h3>
				<h4>   </h4>
				<p>    <?php echo  $m[$i]['Description'] ;?> </p>						
